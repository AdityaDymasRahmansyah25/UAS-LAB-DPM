...
const styles = StyleSheet.create({
  ...
  input: {
    backgroundColor: "#f1f8e9", // Lighter green for input background
    color: "#2e7d32", // Soft green for text
    marginBottom: 15,
    borderRadius: 10,
    padding: 12,
  ...
  button: {
    backgroundColor: "#66bb6a", // Button with modern soft green tone
    borderRadius: 10,
    padding: 14,
    alignItems: "center",
    marginTop: 10,
  ...
  registerText: {
    color: "#4e6b5c", // Softer complementary green
    fontWeight: "600",
    fontSize: 14,
  },
});
